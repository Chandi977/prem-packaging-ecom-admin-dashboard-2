...
import VarientDilaog from "./VarientDilaog";
...
function AddVehicleVariant() {
    ...
    const breadItems = [{ label: "Home" }, { label: "Add Vehicle Variant" }];
    ...
    const handleDelete = async () => {
        ...
        setLoading(true);
        const res = await dispatch(handlePostRequest(data, `/vehicle/varient/delete`, true, true));
        setLoading(false);
        getVehicleManufacturers();
    };
    ...
    const onsuccess = () => {
        ...
        toast.success("vehicle varient added.");
    ...
    return (
        <>
            <Dialog visible={showDialog} header="Vehicle Manufacturer" style={{ width: "750px" }} onHide={() => setShowDialog(false)}>
                <VarientDilaog onsuccess={onsuccess} onHideVehicleManufacturer={onHideVehicleManufacturer} />
            </Dialog>

            <div className="Page__Header">
                <div>
                    <h2>Add Vehicle Varient</h2>
                ...
                <div className="col-12">
                    <div className="card">
                        ...
                        >
                            ...
                            <Column filter field="vehicle_id" header="ID" filterElement={() => handleFilter("vehicle_id")} />
                            <Column filter header="Manufacturer" body={manufacturerTemplate} filterElement={() => handleFilter("manufacturer")} />
                            <Column filter header="Model" body={modelTemplate} filterElement={() => handleFilter("model")} />
                            <Column filter body={imageTemplate} header="Title" filterElement={() => handleFilter("title")} />
                            <Column filter field="year" header="Year" filterElement={() => handleFilter("year")} />
