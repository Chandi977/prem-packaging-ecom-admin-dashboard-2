...
function SubCategory() {
    ...
    const getData = async () => {
        ...
        const result = await handleGetRequest("/category/all");
                        ...
                        <div className="form__">
                            <div className="form_left">
                                <div style={{ marginTop: "10px" }}>
                                    ...
                                    <InputText id="width" name="title" value={sub_category_id} onChange={(e) => setSubCategoryId(e.target.value)} className={classNames({ "p-invalid": isFormFieldValid("width") }, "Input__Round")} />
